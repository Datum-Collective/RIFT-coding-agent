...
export const Info = Schema.Struct({
  ...
  plannerModel: Schema.optional(Schema.String).annotate({
    description: "Model to use for Vibe Mode planning in the format of provider/model",
  }),
  executorModel: Schema.optional(Schema.String).annotate({
    description: "Model to use for Vibe Mode execution in the format of provider/model",
  }),
