...
export const Definitions = {
  ...
  diff_open: keybind("<leader>d", "Open diff viewer to review changes"),
  ...
  view_toggle: keybind("<leader>v", "Switch between the task view and the full log"),
  ...
  session_blocked_next: keybind("<leader>i", "Jump to the next blocked session"),
...
export const CommandMap = {
  ...
  view_toggle: "session.view.toggle",
