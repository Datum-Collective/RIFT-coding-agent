...
export const sessionHandlers = HttpApiBuilder.group(InstanceHttpApi, "session", (handlers) =>
  Effect.gen(function* () {
    ...
    const graphSvc = yield* EngineeringGraph.Service
    ...
    const graph = Effect.fn("SessionHttpApi.graph")(function* (ctx: { params: { sessionID: SessionID } }) {
      yield* requireSession(ctx.params.sessionID)
      return yield* graphSvc.get(ctx.params.sessionID)
    })
