...
for (const item of targets) {
  ...
  await Bun.build({
    ...
    compile: {
      ...
      execArgv: [`--user-agent=rift/${Script.version}`, "--use-system-ca", "--"],
      windows: {},
    },
    files: {
    ...
    define: {
      ...
      // The release tag, kept apart from the runtime version above so updates compare like with like.
      RIFT_VERSION: `'${Script.version}'`,
